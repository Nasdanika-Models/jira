 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.jira.impl.CategoryImpl#getIssues <em>Issues</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	protected EClass eStaticClass() {
		return JiraPackage.Literals.CATEGORY;
	}
	...
	public EList<Issue> getIssues() {
		return (EList<Issue>)eDynamicGet(JiraPackage.CATEGORY__ISSUES, JiraPackage.Literals.CATEGORY__ISSUES, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JiraPackage.CATEGORY__ISSUES:
