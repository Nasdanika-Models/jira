 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.jira.impl.ProgramImpl#getPlans <em>Plans</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
	...
	protected EClass eStaticClass() {
		return JiraPackage.Literals.PROGRAM;
	}
	...
	public EList<Plan> getPlans() {
		return (EList<Plan>)eDynamicGet(JiraPackage.PROGRAM__PLANS, JiraPackage.Literals.PROGRAM__PLANS, true, true);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JiraPackage.PROGRAM__PLANS:
				return getPlans();
		}
