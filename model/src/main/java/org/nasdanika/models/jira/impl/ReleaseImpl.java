 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.jira.impl.ReleaseImpl#getIssues <em>Issues</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReleaseImpl extends MinimalEObjectImpl.Container implements Release {
	...
	protected EClass eStaticClass() {
		return JiraPackage.Literals.RELEASE;
	}
	...
	public EList<Issue> getIssues() {
		return (EList<Issue>)eDynamicGet(JiraPackage.RELEASE__ISSUES, JiraPackage.Literals.RELEASE__ISSUES, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JiraPackage.RELEASE__ISSUES:
