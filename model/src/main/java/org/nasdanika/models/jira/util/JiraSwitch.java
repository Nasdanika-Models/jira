...
public class JiraSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JiraPackage.PROJECT: {
				...
				if (result == null) result = caseIssueSource(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.ROLE: {
				Role role = (Role)theEObject;
				T result = caseRole(role);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.USER_ROLE: {
			...
			case JiraPackage.INITIATIVE: {
				Initiative initiative = (Initiative)theEObject;
				T result = caseInitiative(initiative);
				if (result == null) result = caseIssue(initiative);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.EPIC: {
				Epic epic = (Epic)theEObject;
				T result = caseEpic(epic);
				if (result == null) result = caseIssue(epic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.STORY: {
				Story story = (Story)theEObject;
				T result = caseStory(story);
				if (result == null) result = caseIssue(story);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.TASK: {
				Task task = (Task)theEObject;
				T result = caseTask(task);
				if (result == null) result = caseStory(task);
				if (result == null) result = caseIssue(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.SUBTASK: {
				...
				if (result == null) result = caseIssue(subtask);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.CATEGORY: {
				Category category = (Category)theEObject;
				T result = caseCategory(category);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.RELEASE: {
				Release release = (Release)theEObject;
				T result = caseRelease(release);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.ISSUE_COLLECTOR: {
				IssueCollector issueCollector = (IssueCollector)theEObject;
				T result = caseIssueCollector(issueCollector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.ISSUE_SOURCE: {
				IssueSource issueSource = (IssueSource)theEObject;
				T result = caseIssueSource(issueSource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.FILTER: {
				Filter filter = (Filter)theEObject;
				T result = caseFilter(filter);
				if (result == null) result = caseIssueSource(filter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.BOARD: {
				Board board = (Board)theEObject;
				T result = caseBoard(board);
				if (result == null) result = caseIssueSource(board);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.PLAN: {
				Plan plan = (Plan)theEObject;
				T result = casePlan(plan);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JiraPackage.PROGRAM: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Initiative</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Initiative</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInitiative(Initiative object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Issue Collector</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Issue Collector</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIssueCollector(IssueCollector object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Issue Source</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Issue Source</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIssueSource(IssueSource object) {
		return null;
	}
